...
export default function CareersPage() {
  const activeListings = jobListings.filter((j) => j.active !== false);

  return (
    <>
      <PageHeader
        eyebrow="Join the Team"
        title={<>Careers at <em>Austerra.</em></>}
      ...
      <section className="job-listings" aria-labelledby="job-listings-heading">
        ...
        {activeListings.length > 0 ? (
          <ul className="job-listings__list" role="list" aria-label="Job listings">
          ...
          <div className="job-listings__empty">
            <p className="job-listings__empty-text">
              No current openings — but we&apos;re always interested in hearing from strong
              candidates. Send your CV to{" "}
              <a href="mailto:careers@austerra.com.au">careers@austerra.com.au</a>.
            </p>
          </div>
        )}
      </section>
